...
const ButtonCard: React.FC<ButtonProps> = ({ card, flipped, chooseCard }) => {
  ...
  let classCard = `card ${flipped ? 'matched' : ''} p-2 w-20 h-14 bg-gray-100 flex relative justify-center items-center  md:w-24 md:h-20 xl:w-36 xl:p-2 xl:h-36 2xl:w-48 2xl:h-36  cursor-pointer`
